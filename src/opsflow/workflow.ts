...
import { getStage, type WorkItemType } from './taxonomy.ts'
...
export const ACTIONS: ActionDef[] = [
  ...
  },
  {
    ...
    effect: {
      events: [{ type: 'completed' }],
      closes: 'completed',
      creates: { type: 'payable_invoice', docPrefix: 'INV', relation: 'derived_from', startStage: 'FIN-40', amountFrom: 'nilai_tagihan' },
    },
    tone: 'primary',
  },
  {
    ...
    guards: ['wewenang-cukup'],
    effect: { events: [{ type: 'approved' }, { type: 'completed' }], nextStage: 'FIN-60' },
    tone: 'primary',
  },
  {
    id: 'bayar-eksekusi',
  ...
  },
  {
    ...
    guards: [],
    effect: { events: [{ type: 'returned' }], nextStage: 'PRD-50' },
    tone: 'reject',
  },
  {
    id: 'sj-terbitkan',
    ...
    effect: {
      events: [{ type: 'completed' }],
      nextStage: 'DEL-50',
      creates: { type: 'delivery_order', docPrefix: 'SJ', relation: 'derived_from', startStage: 'DEL-50' },
    },
    tone: 'primary',
  },
  {
  ...
  },
  {
    ...
    outcome: 'Bukti terima tercatat; kiriman selesai dan siap ditagih.',
    stageCode: 'DEL-70',
    appliesTo: ['delivery_order'],
    ...
    fields: [
      ...
      { name: 'diterima_penuh', label: 'Diterima penuh?', type: 'select', required: true, options: [
        { value: 'penuh', label: 'Diterima penuh' },
        { value: 'sebagian', label: 'Sebagian ditolak' },
      ] },
...
export function validateAction(action: ActionDef, ctx: GuardContext): ValidationResult {
  ...
  if (action.stageCode !== ctx.item.currentStageCode) {
    blockers.push({
      guard: 'tahap-cocok',
