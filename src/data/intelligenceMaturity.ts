...
export const intelligenceDimensions: IntelligenceDimension[] = [
  ...
  },
  {
    ...
    northStar: 120,
    status: 'strong',
    meaning: 'Setiap C-level sekarang punya work map visual: lane kerja, dependency, output artifact, dan decision gate.',
    evidence: ['C-level work map', 'Role-specific mermaid output', 'Generated work map draft', 'Chart and diagram support'],
    blindSpot: 'Runtime real agent masih perlu dipaksa mengembalikan map yang sama, bukan hanya mock app-side.',
    upgradeMove: 'Jadikan work map C-level sebagai schema wajib di output Atmaja, lalu validasi otomatis sebelum hasil tampil.',
  },
  {
    id: 'autonomy',
