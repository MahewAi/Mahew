...
export const intelligenceDimensions: IntelligenceDimension[] = [
  ...
  },
  {
    ...
    northStar: 120,
    status: 'developing',
    meaning: 'Blueprint autonomous engine sudah ada, tetapi scheduler, queue, dan approval routing belum hidup penuh.',
    evidence: ['Workflow map', 'Confirmation lane', 'Autonomous engine blueprint'],
    blindSpot: 'AI belum rutin jalan sendiri untuk scan, alert, dan follow-up tanpa diminta.',
    upgradeMove: 'Aktifkan daily scan, weekly council, recurring radar, job queue, dan approval gate.',
  },
  {
    id: 'safety-judgment',
