...
export const plannerRoles: PlannerRole[] = [
  {
    ...
    cadence: 'weekly',
    planningOutputs: ['Master plan', 'Decision memo', 'Risk ledger', 'Next 7 action map'],
  ...
  },
  {
    ...
    cadence: 'weekly',
    planningOutputs: ['Ops roadmap', 'SOP backlog', 'Vendor readiness table', 'Fulfillment risk map'],
  ...
  },
  {
    ...
    cadence: 'weekly',
    planningOutputs: ['Growth roadmap', 'Positioning memo', 'Campaign sprint', 'Market signal board'],
  ...
  },
  {
    ...
    cadence: 'weekly',
    planningOutputs: ['Capital plan', 'Scenario table', 'ROI guardrail', 'Budget checkpoint'],
  ...
  },
  {
    ...
    cadence: 'weekly',
    planningOutputs: ['Document roadmap', 'Memo pack', 'Source log', 'Visual brief deck'],
