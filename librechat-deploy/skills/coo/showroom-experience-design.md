---
name: showroom-experience-design
slug: coo.showroom-experience-design
...
```mermaid
flowchart LR
    A[Sidewalk] --> B[Entry/Foyer<br/>Hero focal]
    B --> C[Japan section]
    C --> D[Europe section]
    D --> E[America section]
    E --> F[China section]
    F --> G[Material Wall<br/>Touch]
    G --> H[Photo Wall<br/>Project showcase]
    H --> I[Konsultasi Pod<br/>Door Expert Zoom]
    I --> J[Exit<br/>Take-away material]
