---
name: audience-emotional-mapping
slug: cco.audience-emotional-mapping
...
```mermaid
journey
    title Customer Emotional Journey Retail Persona
    section Awareness
      First exposure: 4: Customer
      Curiosity build: 6: Customer, Brand
    section Consideration
      Research deeper: 7: Customer
      Confidence grow: 8: Customer, Brand
    section Booking
      Step forward: 8: Customer
      Welcomed: 9: Customer, Door Expert
    section Konsultasi
      Heard deep: 10: Customer, Door Expert
      Educated calm: 9: Customer, Door Expert
    section Decision
      Confident commit: 9: Customer, Door Expert
      Excited: 10: Customer
    section Delivery
      Anticipation: 9: Customer
      Joyful proud: 10: Customer, Brand
    section Aftersales
      Cared: 9: Customer, Door Expert
      Advocate: 10: Customer, Brand
```
...
```mermaid
quadrantChart
    title Persona Aspirational Resonance
    x-axis Practical --> Aspirational
    y-axis Cold Transaction --> Warm Relationship
    quadrant-1 Premium Curated Target
    quadrant-2 Aspirational Cold
    quadrant-3 Practical Cold
    quadrant-4 Practical Warm
    Retail home: [0.85, 0.85]
    Mitra Dagang: [0.6, 0.85]
    Developer: [0.7, 0.7]
    Arsitek Designer: [0.8, 0.85]
    Kontraktor: [0.55, 0.7]
    Aplikator: [0.5, 0.8]
```
