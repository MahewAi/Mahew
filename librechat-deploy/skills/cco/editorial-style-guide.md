...
slug: cco.editorial-style-guide
...
```mermaid
mindmap
  root((7 Editorial Rules))
    1. No em-dash
      Period instead
      Comma instead
    2. Tempat not rumah
      Customer-facing locked
      Alternative hunian
    3. Gerai 1000 Pintu lengkap
      First mention always
      Subsequent OK
...
```mermaid
quadrantChart
    title Tone Position Target
    x-axis Cold Transactional --> Warm Personal
    y-axis Loud Aggressive --> Quiet Refined
    quadrant-1 Target Zone
    quadrant-2 Cold Refined
