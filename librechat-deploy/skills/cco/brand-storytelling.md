...
```mermaid
quadrantChart
    title Storytelling Format Matrix
    x-axis Short Form --> Long Form
    y-axis Single Emotion --> Complex Arc
    quadrant-1 Long Arc Editorial
    quadrant-2 Short Arc Fragment
    quadrant-3 Short Single Moment
    quadrant-4 Long Single Theme
    Philosophy 1500w: [0.85, 0.85]
    Customer journey 1000w: [0.75, 0.85]
    Heritage 500w: [0.55, 0.7]
    Vision 500w: [0.55, 0.65]
    Case study 1500w: [0.85, 0.9]
    IG caption 300w: [0.4, 0.5]
    Story snippet 50w: [0.15, 0.2]
    WhatsApp moment 100w: [0.25, 0.3]
```
