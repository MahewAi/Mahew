...
slug: cco.content-calendar-strategy
...
```mermaid
gantt
    title Content Calendar Q4 2026 - Q3 2027
    dateFormat YYYY-MM-DD
    section Q4 2026 Wave 1
    Pre-launch tease :2026-10-01, 30d
    Launch month :2026-11-01, 30d
    Post-launch reflection :2026-12-01, 31d
    section Q1 2027 Filosofi
    Jepang focus :2027-01-01, 31d
    Eropa focus :2027-02-01, 28d
    Amerika China focus :2027-03-01, 31d
    section Q2 2027 Craftsmanship
    Brass series :2027-04-01, 30d
    Kayu series :2027-05-01, 31d
    Joinery finish :2027-06-01, 30d
    section Q3 2027 Phase 2
    Phase 2 tease :2027-07-01, 31d
    Mitra showcase :2027-08-01, 31d
    Portfolio reveal :2027-09-01, 30d
```

Pillar distribution:

```mermaid
pie title Content Pillar Distribution
    "Philosophy 30%" : 30
    "Product 25%" : 25
    "Door Expert 20%" : 20
    "Showroom 15%" : 15
...
```mermaid
xychart-beta
    title "Content Volume per Channel per Week"
    x-axis [IG-Feed, IG-Story, IG-Reel, TikTok, FB, Blog, Email, WhatsApp]
    y-axis "Post per Week" 0 --> 30
    bar [6, 25, 2.5, 2.5, 3.5, 1.5, 0.5, 1]
```
