...
```mermaid
flowchart TD
    A[Gerai 1000 Pintu<br/>Master Brand 🔒]
    
    A --> B[Product Line]
    A --> C[Service Line]
    A --> D[Channel / Touchpoint]
    
    B --> B1[AMK Premium<br/>Phase 1 anchor]
    B --> B2[Selected Brand Expansion<br/>Phase 2 curated]
    B --> B3[Gerai Signature<br/>Phase 3 evaluate]
    
    C --> C1[Konsultasi Door Expert<br/>Phase 1]
    C --> C2[Aftersales Premium<br/>Phase 1]
    C --> C3[Project Partnership<br/>Phase 2]
    
    D --> D1[Showroom Cabang<br/>BPN P1]
    D --> D2[gerai.mahewwork.com]
    D --> D3[Social: IG TikTok]
    D --> D4[WhatsApp Business]
    D --> D5[Cabang Samarinda<br/>Bontang Phase 2]
    
    style A fill:#B8956B
    style B1 fill:#D4B895
    style C1 fill:#D4B895
    style D1 fill:#D4B895
```
...
```mermaid
gantt
    title Brand Architecture Expansion
    dateFormat YYYY-MM-DD
    section Master Brand
    Gerai 1000 Pintu LOCKED :active, 2026-09-01, 1825d
    section Product Line
    AMK Premium :2026-11-14, 365d
    Selected Brand Expansion :2027-06-01, 365d
    Gerai Signature evaluate :2028-06-01, 180d
    section Service
    Konsultasi Door Expert :2026-11-14, 1095d
    Aftersales Premium :2026-11-14, 1095d
    Project Partnership :2027-04-01, 365d
    section Channel
    Cabang Balikpapan :milestone, 2026-11-14, 0d
    Cabang Samarinda :milestone, 2027-09-01, 0d
    Cabang Bontang :milestone, 2027-12-01, 0d
    Cabang Jawa Q1 2028 :milestone, 2028-03-01, 0d
```
