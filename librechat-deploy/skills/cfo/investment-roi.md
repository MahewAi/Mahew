...
```mermaid
quadrantChart
    title Investment ROI vs Size
    x-axis Small Investment --> Large Investment
    y-axis Low ROI --> High ROI
    quadrant-1 Strategic Big Bet
    quadrant-2 Quick Win Strategic
    quadrant-3 Pass Skip
    quadrant-4 Comfortable Investment
    Wave 1 marketing: [0.8, 0.85]
    Cabang BPN: [0.85, 0.85]
    Cabang SMR: [0.85, 0.7]
    CRM custom: [0.4, 0.65]
    AI Department: [0.35, 0.85]
    Catalog print: [0.35, 0.95]
    Photography library: [0.55, 0.85]
    Influencer KOL: [0.3, 0.7]
    Tools subscription: [0.2, 0.95]
    Manuscript publishing: [0.35, 0.55]
```
...
```mermaid
xychart-beta
    title "Payback Period per Investment (Month)"
    x-axis [Tools, Logistics, Influencer, AI-Dept, Cabang-BPN, Wave1-Marketing, Catalog, Cabang-SMR, Photography, Manuscript]
    y-axis "Month" 0 --> 24
    bar [1, 3, 3, 4, 5, 4, 6, 10, 6, 18]
```
...
pie title Investment Distribution Year 1
    "Capex Showroom 35%" : 35
    "Marketing Wave 1 25%" : 25
    "Tech + Tools 12%" : 12
    "Brand Asset 12%" : 12
    "Vendor + Inventory 16%" : 16
```
