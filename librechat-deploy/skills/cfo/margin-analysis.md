...
| EBITDA margin | {%} | TBD (foundation Year 1) | - |
| Net margin | {%} | -10 to 0 Year 1 | - |
...
```mermaid
pie title Margin Contribution by Tier
    "Tier 2 Curated 62%" : 62
    "Tier 1 Essential 24%" : 24
    "Tier 3 Statement 11%" : 11
    "Tier 4 Heritage 3%" : 3
```
...
```mermaid
xychart-beta
    title "Gross Margin % per Persona"
    x-axis [Retail, Mitra, Developer, Arsitek-gross, Arsitek-net, Kontraktor]
    y-axis "Margin %" 0 --> 40
    bar [32, 28, 29, 30, 23, 27]
```
...
```mermaid
xychart-beta
    title "Margin Trajectory 5-Year"
