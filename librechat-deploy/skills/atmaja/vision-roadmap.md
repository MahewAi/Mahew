...
```mermaid
gantt
    title Gerai 1000 Pintu 5-Year Roadmap
    dateFormat YYYY-MM-DD
    section Phase 1 Foundation
    Wave 1 launch :milestone, 2026-11-14, 0d
    Year 1 steady :2026-11-14, 365d
    Phase 1-2 gate :crit, milestone, 2027-09-01, 0d
    section Phase 2 Kaltim Scale
    Cabang 2 Samarinda :2027-10-01, 365d
    Cabang 3 Bontang :2028-01-01, 305d
    Mitra Dagang formal :2028-03-01, 270d
    Phase 2-3 gate :crit, milestone, 2028-09-01, 0d
    section Phase 3 Jawa
    First Jawa cabang :2029-01-01, 365d
    National network :2029-04-01, 365d
    Phase 3-4 gate :crit, milestone, 2030-09-01, 0d
    section Phase 4 Option
    Indonesia consolidation :2030-09-01, 365d
    Optional ASEAN entry :2031-01-01, 365d
```
...
mindmap
  root((5-Year Vision))
    Phase 1 Foundation 2026-2027
      ...
      Lean Store validate
      Brand foundation
    Phase 2 Kaltim Scale 2027-2028
      Cabang Samarinda
      Cabang Bontang
      Mitra Dagang network
      Door Expert pool
    Phase 3 Jawa 2028-2030
      Cabang Jakarta or Surabaya
      Architect partnership national
      Brand awareness 15%
      IP compounding
    Phase 4 Option 2031+
      Indonesia consolidation
      ASEAN ext optional
      Editorial IP licensing
      Cultural ambassador
```
...
```mermaid
flowchart TD
    A[Phase 1 Start Nov 2026] --> B[Q3 2027 Gate Review]
    B --> C{Gate criteria met?}
    
    C -->|Yes 6/6| D[Phase 2 launch Q4 2027]
    C -->|No| E[Phase 1 extend 6-12 month]
    E --> B
    
    D --> F[Q3 2028 Gate Review]
    F --> G{Gate criteria met?}
    
    G -->|Yes| H[Phase 3 Jawa Q1 2029]
    G -->|No| I[Phase 2 extend]
    I --> F
    
    H --> J[Phase 4 Option 2030+]
