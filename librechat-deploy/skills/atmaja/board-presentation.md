...
slug: atmaja.board-presentation
...
```mermaid
quadrantChart
    title Deck Variant per Audience
    x-axis Operational Detail --> Strategic Vision
    y-axis Internal --> External
    quadrant-1 Investor External
    quadrant-2 Press Editorial
    quadrant-3 Board Internal
    quadrant-4 Strategic Off-site
    Board Internal Quarterly: [0.3, 0.15]
    Angel Investor: [0.75, 0.75]
    Growth Series A: [0.65, 0.85]
    Press Editorial: [0.85, 0.6]
    Strategic Off-site: [0.6, 0.25]
```
...
```mermaid
gantt
    title Board Presentation Production Cycle
    dateFormat YYYY-MM-DD
    section Plan
    Brief intake :2026-09-01, 1d
    Outline :2026-09-02, 2d
    section Produce
    Content draft :2026-09-04, 5d
    Brand canon validate :2026-09-09, 1d
    Visual production :2026-09-10, 5d
    section Review
    Matthew + C-Level review :2026-09-15, 3d
    Revision Round 1-2 :2026-09-18, 4d
    section Deliver
    Final + speaker note :2026-09-22, 2d
    Presentation :milestone, 2026-09-25, 0d
    section Post
    Feedback + version :2026-09-26, 2d
```
