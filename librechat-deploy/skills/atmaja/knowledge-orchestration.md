...
slug: atmaja.knowledge-orchestration
...
flowchart TD
    ...
    A -.read all.-> E[All team]
    B -.cross-function.-> E
    C -.function team.-> F[Functional team]
    D -.operational.-> G[Operations team]
...
```mermaid
flowchart LR
    A[Generation<br/>customer/sprint/event] --> B[Capture<br/>CRM/Notion/template]
    B --> C[Curation<br/>Atmaja synthesis]
    C --> D[Distribution<br/>tier appropriate]
    D --> E[Application<br/>decision + skill]
    E --> F[Evolution<br/>refresh/archive]
    F --> A
...
```mermaid
mindmap
  root((Learning Culture))
    Individual
      Monthly book article
      Quarterly course
