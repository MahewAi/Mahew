...
slug: atmaja.governance-framework
...
```mermaid
flowchart TD
    A[Matthew CEO<br/>Founding Authority] --> B[Atmaja Stewardship]
...
```mermaid
gantt
    title Annual Meeting Cadence
    dateFormat YYYY-MM-DD
    section Daily
    WhatsApp standup :active, 2026-01-01, 365d
    section Weekly
    Operations sync :active, 2026-01-01, 365d
    Friday recap :active, 2026-01-01, 365d
    section Bi-weekly
    Sprint planning :2026-01-01, 14d
    section Monthly
    Function deep-dive :2026-01-15, 30d
    Brand canon audit :2026-01-20, 30d
    Cash flow review :2026-01-25, 30d
    section Quarterly
    QBR :crit, milestone, 2026-03-31, 0d
    Strategic off-site :2026-03-25, 5d
    section Annual
    Annual strategic review :crit, 2026-12-15, 10d
```
...
flowchart LR
    ...
    B -->|P0| C[Matthew immediate <1h]
    B -->|P1| D[Atmaja + Matthew <4h]
    B -->|P2| E[C-Level <24h]
    B -->|P3| F[Functional standard]
    
    C --> G[Documentation + cascade]
    D --> G
    E --> G
    F --> G
