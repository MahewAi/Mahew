...
slug: atmaja.vision-articulation
...
```mermaid
quadrantChart
    title Vision Articulation Audience Matrix
    x-axis Brief --> Comprehensive
    y-axis Internal --> External
    quadrant-1 External Comprehensive
    quadrant-2 External Brief
    quadrant-3 Internal Brief
    quadrant-4 Internal Comprehensive
    Elevator public: [0.15, 0.65]
    Customer brand voice: [0.4, 0.85]
    Press editorial: [0.7, 0.8]
    Investor deep-dive: [0.85, 0.85]
    New hire onboarding: [0.45, 0.25]
...
mindmap
  root((Vision Gerai))
    ...
    Evolving Elements
      ...
      Channel Mix
    Memorable Anchors
      Tempat impian dimulai
      Empat dunia empat karakter
      Bukan transaksi pendampingan
      Refined hangat timeless
```
