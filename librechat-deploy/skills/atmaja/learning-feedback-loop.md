...
slug: atmaja.learning-feedback-loop
...
```mermaid
flowchart LR
    A[Observe<br/>Pattern detect] --> B[Hypothesize<br/>Atmaja formulate]
    B --> C[Test<br/>Experiment design]
    C --> D[Validate<br/>Compare outcome]
    D --> E{Validated?}
    
    E -->|Yes| F[Apply<br/>Skill update + behavior]
    E -->|No| G[Reject<br/>Document learning]
    E -->|Ambiguous| H[Continue test<br/>More data]
    
    F --> I[Refine<br/>Monthly audit]
    G --> A
    H --> C
    
    I --> J{Still Valid?}
    J -->|Yes| I
    J -->|No| K[Deprecate<br/>Loop back]
    K --> A
...
```mermaid
quadrantChart
    title Feedback Source Authority + Cycle
    x-axis Low Cycle Frequency --> High Cycle Frequency
    y-axis Low Authority --> High Authority
    quadrant-1 Continuous Decisive
    quadrant-2 Decisive Periodic
    quadrant-3 Low Priority
    quadrant-4 Frequent Low Weight
    Matthew Direct: [0.85, 0.95]
    Customer Outcome: [0.8, 0.85]
    Brand Canon Audit: [0.85, 0.8]
    Operational KPI: [0.85, 0.65]
    Cross-Agent Synthesis: [0.55, 0.6]
    External Signal: [0.3, 0.4]
```
...
```mermaid
mindmap
  root((5 Hypothesis Test Patterns))
    A/B Style Preference
      Brief vs Detail
      Visual vs Text
      Direct vs Warm
    Customer Conversion
      Konsultasi intro timing
      Recommendation framing
      Aftersales touchpoint
    Channel Optimization
      Architect vs Instagram
      Walk-in vs Web booking
      Email vs WhatsApp
    Brand Canon Edge Case
      Gerai shortened context
      Tempat alternative
      Em-dash exception
    Operational Process
      Standup duration
