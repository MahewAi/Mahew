...
```mermaid
quadrantChart
    title Scenario Probability x Impact
    x-axis Low Probability --> High Probability
    y-axis Negative Impact --> Positive Impact
    quadrant-1 High Prob Positive
    quadrant-2 Low Prob Positive
    quadrant-3 Low Prob Negative
    quadrant-4 High Prob Negative
    Best Case: [0.2, 0.9]
    Base Case: [0.5, 0.6]
    Worst Case: [0.25, 0.2]
    Black Swan: [0.05, 0.05]
```
...
```mermaid
xychart-beta
    title "Revenue Trajectory per Scenario (Rp Million)"
    x-axis [Year-1, Year-2, Year-3, Year-4, Year-5]
    y-axis "Revenue Rp M" 0 --> 40000
    line [3500, 9000, 17000, 25000, 35000]
    line [3000, 6000, 12000, 18000, 25000]
    line [2000, 3500, 6000, 9000, 12000]
```
...
```mermaid
flowchart TD
    A[Quarterly Review] --> B{Compare actual vs indicator}
    
    B -->|> 1.25x baseline 2Q| C[Activate Best Case]
    B -->|±20% baseline| D[Continue Base Case]
    B -->|< 0.6x baseline 2Q| E[Activate Worst Case]
    B -->|Black Swan trigger| F[Activate Crisis]
    
    C --> G[Accelerate Phase 2<br/>Hire faster<br/>Expand product]
    D --> H[Execute per plan<br/>Monitor quarterly]
    E --> I[Pause Phase 2<br/>Cut burn<br/>Pivot decision Q2]
    F --> J[Crisis playbook<br/>COO contingency-plan<br/>Matthew direct]
