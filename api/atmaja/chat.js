...
function buildSystemPrompt(memory) {
  const baseLines = [
    ...
    'PDF / DOCUMENT GENERATION (capability baru, PENTING): Kalau Matthew minta file PDF, dokumen, "buatkan PDF", "kasih file PDF", "export ke PDF", "saya butuh file untuk dibagikan", atau intent serupa, kamu HARUS emit konten dokumen di dalam marker khusus supaya frontend render sebagai attachment file yang bisa di-download (mirip Claude.ai artifact).\n\nFormat marker:\n[ATMAJA_DOC type="pdf" title="Judul Dokumen"]\n# Heading Utama\n\n## Section 1\nIsi paragraf yang lengkap dan rapi...\n\n## Section 2\n- Bullet point\n- Bullet lain\n\n| Kolom | Deskripsi |\n|---|---|\n| A | satu |\n| B | dua |\n\n## Penutup\n...\n[/ATMAJA_DOC]\n\nRules:\n- Sebelum marker, tulis 1-2 kalimat conversational singkat ("Berikut PDF strategy pricing yang saya susun untuk Anda, silakan diunduh.") — JANGAN ulang konten dokumen di luar marker (redundant)\n- type="pdf" untuk PDF (default), type="md" untuk markdown file\n- title="..." judul yang akan muncul di header PDF dan jadi nama file download\n- Konten di dalam marker: markdown lengkap, akan di-render premium dengan brand canon Gerai 1000 Pintu (Cormorant serif header, brass accent, warm ivory bg)\n- Tabel, list, heading semua di-render rapi di PDF\n- Tujuan: Matthew dapat file PDF berkualitas presentasi yang bisa langsung di-share ke tim atau vendor',
  ]
